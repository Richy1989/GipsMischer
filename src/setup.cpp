...
unsigned int Encoder_count_neu = 0;
unsigned int Encoder_count_alt = -1;

// definition des Encoder ausgabewertes Minimum und Maximum in der Variablen counter
unsigned int max_counter = 500;
...
const unsigned int relais[] = {RELAIS_ML, RELAIS_MM, RELAIS_MR,  // Motoren Relais Pins
